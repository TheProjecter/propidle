...
import com.googlecode.propidle.authentication.requests.FailedLoginRequest;
import com.googlecode.propidle.authentication.requests.LoginByUnprivilegedUser;
import com.googlecode.propidle.authentication.requests.PostRequest;
...
public class AuthenticationTest extends AcceptanceTestCase {
    ...
    private ActionUnderTest anUnauthenticatedUserGetsTheAuthenticationPage() {
        return request(com.googlecode.propidle.authentication.requests.GetAuthenticationResourceRequest.class);
    }
    ...
    private ActionUnderTest anUnauthenticatedUserMakesAGetRequest() {
        return request(com.googlecode.propidle.authentication.requests.GetRequest.class);
    }
