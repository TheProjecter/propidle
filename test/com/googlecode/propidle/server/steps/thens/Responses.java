package com.googlecode.propidle.server.steps.thens;

import com.googlecode.propidle.server.steps.Then;
    ...
    public static Callable1<Response, String> content() {
        return new Callable1<Response, String>() {
            public String call(Response response) throws Exception {
                assertThat("Expected a successful response", response.status().code(), allOf(greaterThanOrEqualTo(200), lessThan(300)));
